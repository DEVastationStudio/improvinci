...
* Un solo trazo: el dibujo tendrá que realizarse sin levantar el pincel del lienzo, es decir, el ratón o dedo, dependiendo de la plataforma.
...
La música también se podrá escuchar en todo momento excepto durante el tiempo de dibujo de forma que no se distraiga a los jugadores.

## 7.2. Efectos sonoros
Los efectos sonoros acompañarán cada acción de los usuarios y cada momento relevante en el que el juego les muestra información o les da feedback. Todos los efectos tendrán un toque divertido y alocado acorde con la estética cartoon, por lo que abundarán los sonidos agudos y exagerados.

## 7.3. Lista de sonidos
* Música intro y lobby
* Ruido ambiente: público murmurando, reverberación
* Cuenta atrás cuando queden pocos segundos, gameplay
* Efectos asociados a botones
* Sonido al dibujar
* Sonido reset
* Efecto de revelación de las letras para el infiltrado
* Revelación del impostor tras las votaciones, música
* Cuenta atrás cuando queden pocos segundos, votaciones
* Música final de victoria, podio, aplausos jaleos

# 8. Interfaz
## 8.1. Diseños básicos de los menús

El menú solo tendrá 3 botones, el botón para jugar, el botón de desactivar y activar sonido, el botón de las puntuaciones que sirve para ver los mejores resultados conseguidos en partidas anteriores y el botón que nos lleva a los créditos, desde donde se podrá volver al menú.

Una vez se pulsa Jugar nos lleva a una sala para dibujar nuestro avatar, tras pulsar el botón Listo accedemos al Prelobby, sala donde decidiremos si crear partida o unirse a una ya creado por código.

En la lobby ya veremos los retratos de los demás jugadores, el host podrá configurar la partida por tiempos, número de rondas y modos de juego. 

Durante el juego los jugadores verán lo mismo, habrá un botón de resetear el dibujo y otro de desactivar el tiempo. El improvisador (rosa) tendrá disponible el botón de ver el lienzo de otro jugador.

Durante las votaciones se verán los cuadros de todos los jugadores, se tendrá que seleccionar el cuadro que se quiera votar y pulsar un botón para confirmarlo. Cuando se acabe el tiempo se sustituirán los cuadros por los retratos y aparecerán las puntuaciones, también se revelará quién es el infiltrado y el jugador que vaya ganando la partida.
